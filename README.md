...
#### Dockerfile postgresql 13.4 debian 11 buster
...
**Postgres required by moodle**

```bash
docker run \
	-p 5432:5432 \
	--name pimp-postgres \
	--hostname pimp-postgres \
	--restart=always \
	-v /srv/pimp-postgres:/var/www/html/pimp-moodle \
	-e EDITOR=vim \
	-e VISUAL=vim \ 
	-e POSTGRES_DB=moodle \
	-e POSTGRES_USER=moodle \
	-e POSTGRES_PASSWORD=senhasupersecretaprachuchu@adc321 \
	-v /srv/pimp-postgres/data:/var/lib/postgresql/data/pgdata \
	-v /srv/pimp-postgres/conf:/etc/postgresql \
	-d satangos/postgres
```

**Remember to copy your config file to /srv/pimp-postgres/conf:**
